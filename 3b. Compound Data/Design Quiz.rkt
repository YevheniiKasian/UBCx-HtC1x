...
;; interp. flower with x position, y position and a side length
...
;; Flower -> Image
;; renders the flower of the the given size on the MTS
...
(check-expect (render (make-flower 10 10 370)) (place-image (rotate 10 (scale(/ 370 100) FLOWER)) 10 10 MTS))
